...
void loop(){
 ...
 // convert microseconds to seconds ( 10^-6 ) and Farads to picoFarads ( 10^9 ),  net 10^6 (1000000)  
  microFarads = ((float)elapsedTime / resistorValue) * 1000000.00000;  
  //Serial.print(elapsedTime);       // print the value to serial port
  //Serial.print(" uS    ");         // print units and carriage return


  //if (microFarads > 1){
    Serial.println((float)microFarads*1.0);       // print the value to serial port
